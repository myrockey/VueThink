            ...
            <el-main>
                <div class="hs-container">
                   <div class="hs-news-detail-box">
                       ...
                       <div class="hs-news-detail-desc tx-c"><span class="p-r-20">{{newsData.copyfrom}}</span> {{newsData.create_time | formatDate2}}</div>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.apiGet('v1/api/articles/' + this.id).then((res) => {
        console.log(res)
