...
class Search extends  HomeBase
{
   ...
   $docdownrankday=parent::$commonLogic->getDataList('docdown',['m.create_time'=>array('gt',$daytime)], 'm.*,count(m.id) as downcount,doccon.title', 'downcount desc',false,[['doccon','m.did=doccon.id']],'m.did',10);
   $docdownrankzhou=parent::$commonLogic->getDataList('docdown',['m.create_time'=>array('gt',$zhoutime)], 'm.*,count(m.id) as downcount,doccon.title', 'downcount desc',false,[['doccon','m.did=doccon.id']],'m.did',10);
   $docdownrankmouth=parent::$commonLogic->getDataList('docdown',['m.create_time'=>array('gt',$mouthtime)], 'm.*,count(m.id) as downcount,doccon.title', 'downcount desc',false,[['doccon','m.did=doccon.id']],'m.did',10);
